      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="ghost" onClick={() => navigate('/admin/job-forms')}>
          ...
          <div className="flex items-center gap-2">
            {isEditing && (
              <Button variant="outline" onClick={() => window.open(`/apply/job/${formSlug}`, '_blank')}>
            ...
            <div className="col-span-3 space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="batch">Batch / Department Label</Label>
                    <Input
                      id="batch"
                      value={batchName}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="start-date">Expected Joining Date</Label>
                    <Input
                      id="start-date"
                      type="date"
                      value={startDate}
                  ...
                  {/* Job Benefits */}
                  <div className="space-y-2">
                    <Label>Job Benefits / Perks</Label>
