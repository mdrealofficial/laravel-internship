...
import { ArrowLeft, CheckCircle, Loader2, BadgeDollarSign, Gift, ChevronRight, Check, CalendarDays, Clock, Building2 } from 'lucide-react';
          ...
          <div className="rounded-2xl bg-white border border-gray-200 shadow-lg overflow-hidden">
            ...
            <div className="px-6 pt-8 pb-6 sm:px-8 border-b border-gray-100">
              ...
              <div className="flex flex-wrap items-center gap-2 mb-4">
                ...
                {form.batch_name && (
                  <span className="inline-flex items-center rounded-full bg-indigo-50 border border-indigo-100 px-3 py-1 text-xs font-semibold text-indigo-600">
                    {form.batch_name}
                  </span>
                )}
              </div>
                ...
                <div className="flex flex-wrap gap-3 mt-5">
                  {startDate && (
                    <div className="flex items-center gap-2 rounded-xl bg-indigo-50 border border-indigo-100 px-3.5 py-2.5">
                      ...
                      <div>
                        <p className="text-[10px] font-semibold text-indigo-400 uppercase tracking-wide leading-none mb-0.5">Starts</p>
            ...
            <div className="px-6 py-7 sm:px-8 space-y-7">
              ...
              {/* Internship type highlight */}
              {isPaid ? (
                <div className="rounded-xl border-2 border-green-200 bg-green-50 p-5">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="flex-shrink-0 rounded-full bg-green-500 p-1.5 shadow-sm">
                      <Check className="h-4 w-4 text-white stroke-[3]" />
                    </div>
                    <p className="font-bold text-green-800 text-base">Paid Internship</p>
                  </div>
                  {stipend ? (
                    <div className="ml-10">
                      <p className="text-[11px] font-semibold text-green-500 uppercase tracking-widest mb-0.5">Monthly Stipend</p>
                      <p className="text-3xl font-black text-green-700 leading-none">
                        BDT {Number(stipend).toLocaleString()}
                        <span className="text-sm font-normal text-green-500 ml-1">/month</span>
                      </p>
                    </div>
                  ) : (
                    <p className="ml-10 text-sm text-green-600">Compensation details will be shared upon selection.</p>
                  )}
                </div>
              ) : (
                <div className="rounded-xl border-2 border-amber-200 bg-amber-50 p-5">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="flex-shrink-0 rounded-full bg-amber-400 p-1.5 shadow-sm">
                      <Check className="h-4 w-4 text-white stroke-[3]" />
                    </div>
                    <p className="font-bold text-amber-800 text-base">Unpaid Internship</p>
                  </div>
                  <p className="ml-10 text-sm text-amber-700 leading-relaxed">
                    No monetary compensation is provided — but you'll gain hands-on experience, real-world skills, mentorship, and the perks listed below.
                  </p>
                </div>
              )}
              ...
              {facilitiesList.length > 0 && (
                <div>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-base font-bold text-gray-800">What You'll Get</h2>
                  </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-5">
                <p className="text-sm text-gray-500 leading-relaxed mb-5">
                  By clicking <strong className="text-gray-800">Agree & Continue</strong>, you confirm that you have read and understood the internship details above and agree to proceed with your application.
                </p>
